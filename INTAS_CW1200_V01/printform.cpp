...
void PrintForm::print(QPrinter *printer) {
...
void PrintForm::print_two_tables(QPrinter *printer) {
...
void PrintForm::uglyPrint(QPrinter *printer) {
...
void PrintForm::on_pushButton_2_clicked() {
...
void PrintForm::on_pushButton_3_clicked() {
    QPrintPreviewDialog dialog;
