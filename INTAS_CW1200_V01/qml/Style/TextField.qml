...
TextBase {
    ...
    property alias aceptInput: textInput.acceptableInput
    ...
    Flickable {
        ...
        TextInput {
            id: textInput
//            EnterKey.actionId: textArea.enterKeyAction
//            EnterKey.enabled: textArea.enterKeyEnabled
            ...
            passwordCharacter: "\u2022"
            font.pixelSize: UIStyle.fontSizeXXL     // UIStyle.fontSizeXS      //textField.fontPixelSize
            selectionColor: Qt.rgba(0.0, 0.0, 0.0, 0.15)
            selectedTextColor: color
        //    selectByMouse: true
        //    width:UIStyle.prdParamWidth     // Math.max(flickable.width, implicitWidth)-2
